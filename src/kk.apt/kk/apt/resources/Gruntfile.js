...
module.exports = function (grunt) {
    ...
    grunt.initConfig({
        ...
        sed: {
            ...
            'clean-source-js': {
                path: 'dist/',
                pattern: '../dist/js/apt.js',
                replacement: 'js/apt.min.js',
                recursive: true
            },
            'clean-logo': {
                path: 'dist/theme.html',
                pattern: '../assets/img/logo-apt.png',
                replacement: '/++theme++kk.apt/dist/assets/img/logo-apt.png'
            },
            'clean-logo-signin': {
            ...
            'clean-claim': {
                ...
                replacement: '/++theme++kk.apt/dist/assets/img/claim.png'
            }
        },
